...
const InfoCardUser = ({ user, readOnly, handleDeletion }) => {
  ...
  const deptRemains = () => {
    return userFullName === newUser.fullName && userMbPhone === newUser.mbPhone;
  };
