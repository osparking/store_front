...
const normalSoap1 = normalSoaps[0];
    ...
    <Container fluid className="home-container mt-5">
      <Row className="justify-content-center allIngred mt-3">
        <Col md={8}>
          ...
          <ul>
            <li>
              <strong>향오일 종류</strong> - 범이가 사용한 제주 비자나무
            ...
            <li>
              <strong>소다회 유무</strong> - 범이비누가 5 주간 숙성되는 동안
              비누 표면에 백색 소다회가 만들어질 수 있습니다. 소다회가 생기는
              것은 비누 건조대 주변이 온도가 낮기 때문인 것으로 추정됩니다. 당시
              범이비누는 12월 말부터 2월 5일 경까지 제조되었습니다.
            </li>
          </ul>
        </Col>
      </Row>
