            ...
            <Card>
              ...
              <Card.Body className="pt-0">
                <Card.Text>
                  ...
                  것은 2019년 봄이었을 겁니다. 평소 피부 가려움증으로 매해
                  가을의 시작과 함께 저는 이른바 피부 트러블로 이듬해 우수
                  경칩이 될 때까지 피부에 거의 온 신경을 쓰면서 지내야 했기
                  때문에 수제비누가 제게 안겨준 평온함은 정말 돈으로 가치를
                  따지기 어려울 정도였습니다.
                </Card.Text>
                <Card.Text>
            ...
            <Card id="homeRightCard">
              ...
              <Card.Body className="mt-0 pt-0">
                ...
                <Card.Text className="mt-3">
                  고객님들의 성원과 참여도에 따라 재료 대량 구매, 생산 작업의
                  부분 자동화 등을 통하여 비누 가격이 내려갈 수 있으며, 에센셜
                  향오일을 사용하는 등의 품질 고급화 및 다양화가 가능할 수
                  있습니다.
                </Card.Text>
                <div className="text-center mt-1 button-div">
